...
SONIC_MASTER_MAY30_COMMIT="c37c94934292dba90839574d90dc89f539908c55"
...
declare -A P1=( [NAME]=sonic-buildimage [DIR]=. [PR]="3687 4703" [URL]="$url" [PREREQ]="" [POSTREQ]="")
...
pre_patch_help()
{
    ...
    log "git checkout $SONIC_MASTER_MAY30_COMMIT"
...
master_armhf_fix()
{
    ...
    # sonic_yang patch
    wget -c https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/sonic_yang_wa_MAY30.patch 
    patch -p1 --dry-run < ./sonic_yang_wa_MAY30.patch 
    echo "sonic-yang fix test"
    patch -p1 < ./sonic_yang_wa_MAY30.patch
}
...
main()
{
    ...
    if [ "${sonic_buildimage_commit}" != "$SONIC_MASTER_MAY30_COMMIT" ]; then
